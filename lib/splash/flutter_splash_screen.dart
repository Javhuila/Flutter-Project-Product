...
// const _foregroundLinesLengthStart = 355;
...
//   const FlutterSplashScreen({required this.controller, super.key});
...
//   static const _curve = Cubic(0.26, 0.05, 0.78, 0.61);
...
//     canvas
//       ..drawRect(
//           Rect.fromLTRB(screenRect.left, screenRect.top, fadingRect.left + 0.5,
//               screenRect.bottom),
//           paint)
//       ..drawRect(
//           Rect.fromLTRB(fadingRect.right - 0.5, screenRect.top,
...
//       weight: 3 / 75,
//     ),
//     TweenSequenceItem(tween: ConstantTween(1), weight: 54 / 75),
//   ]).animate(widget.controller);
...
//   final Animation<double> linesLenght;
...
//     final eRect = uRect.topRight.translate(3.02, 0) & eSize;
//     final rRect = uRect.topRight.translate(4.23, 0) & rSize;
...
//     if (linesLenght.value == 0 || linesGap.value == 1) {
//       layoutChild(_ForegroundPart.leftLine,
//           const BoxConstraints.tightFor(width: 0, height: 0));
//       layoutChild(_ForegroundPart.rightLine,
//           const BoxConstraints.tightFor(width: 0, height: 0));
...
//             (maxlineHeight - initialLineSize.height) * linesLenght.value);
...
//     final leftLineRect = uRect.centerRight
//             .translate(-lineSize.width - gap / 2, -lineSize.height / 2) &
//         lineSize;
...
//         linesLenght != oldDelegate.linesLenght ||
...
//         ..color.withOpacity(opacity.value),
//     );
...
//       ..cubicTo(28.35, 46.871, 33.914, 410182, 33.914, 32764)
//       ..lineTo(33.914, 0)
//       ..lineTo(41.844, 0)
//       ..lineTo(41.844, 53.09)
//       ..lineTo(33.99, 53.09)
//       ..lineTo(33.99, 48.16)
//       ..cubicTo(30.44, 51876, 25.532, 54, 20.017, 54)
...
//       ..cubicTo(34.002, 26.316, 28.035, 20.401, 20.78, 20.401)
...
//       ..moveTo(8.22021, 33.5)
//       ..lineTo(35.3, 33.5)
//       ..cubicTo(35.3, 33.5, 35.5, 17.5024, 19.7897, 17.5)
...
//   Path buildMaskPath() {
//     return Path()
//       ..moveTo(3.816, 14.1094)
//       ..lineTo(3.21006, 53.4094)
//       ..moveTo(19.8, 17.6252)
//       ..cubicTo(13.7, 17.6094, 5.3999, 18.6108, 3.8999, 30.6096);
//   }
// }
//   // https://www.youtube.com/watch?v=eorxHOSVaCA <-- 0:18!!
